...
const VerticalMenu = ({ dictionary, scrollMenu }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <MenuItem href={`/${locale}/dashboards/crm`}>{dictionary['navigation'].home}</MenuItem>
        ...
        <MenuSection label={dictionary['navigation'].clientsManagement}>
          ...
          { /*  <MenuItem href={`/${locale}/client/requirements`}>{dictionary['navigation'].searchRequirements}</MenuItem>
            <MenuItem href={`/${locale}/client/historical`}>{dictionary['navigation'].contactHistory}</MenuItem> */ }
          </SubMenu>
          ...
          >
            ...
            { /*    <MenuItem href={`/${locale}/property/status`}>{dictionary['navigation'].statusAndPublication}</MenuItem>
            <MenuItem href={`/${locale}/property/docs`}>{dictionary['navigation'].docs}</MenuItem> */ }
          </SubMenu>
        ...
        <MenuSection label={dictionary['navigation'].comercialManagement}>
          ...
          >
            ...
            { /* <MenuItem href={`/${locale}/opportunity/add`}>{dictionary['navigation'].newOpportunity}</MenuItem>
            
            <MenuItem href={`/${locale}/opportunity/pipeline`}>{dictionary['navigation'].opportunitiesPipeline}</MenuItem>
            <MenuItem href={`/${locale}/opportunity/autoMatch`}>{dictionary['navigation'].autoMatching}</MenuItem>
            <MenuItem href={`/${locale}/opportunity/manualMatch`}>{dictionary['navigation'].manualSuggestions}</MenuItem>
            <MenuItem href={`/${locale}/opportunity/visit`}>{dictionary['navigation'].visitSchedule}</MenuItem>
            <MenuItem href={`/${locale}/opportunity/offer`}>{dictionary['navigation'].generateOffer}</MenuItem> */ }
          </SubMenu>
          ...
          >
            ...
            { /* <MenuItem href={`/${locale}/visit/afterSale`}>{dictionary['navigation'].postVisitFollowup}</MenuItem>
            <MenuItem href={`/${locale}/visit/report`}>{dictionary['navigation'].interestReport}</MenuItem> */ }
          </SubMenu>
          ...
          >
            ...
            { /* <MenuItem href={`/${locale}/offer/status`}>{dictionary['navigation'].approvalStatus}</MenuItem>
            <MenuItem href={`/${locale}/offer/approval`}>{dictionary['navigation'].ownerApproval}</MenuItem>
            <MenuItem href={`/${locale}/offer/history`}>{dictionary['navigation'].history}</MenuItem> */ }
          </SubMenu>
        </MenuSection>
