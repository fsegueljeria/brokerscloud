...
import { LeadMessage, Lead } from "@/types/types"

// Mensajes de ejemplo más realistas en español
const exampleMessages: LeadMessage[] = [
  {
    id: "msg-1",
    leadId: "lead-1",
...
export function LeadMessages({ isOpen, onClose, lead, messages = [], onSendMessage }: { isOpen: boolean, onClose: () => void, lead: Lead, messages: LeadMessage[], onSendMessage: (leadId: string, message: string) => void }) {
