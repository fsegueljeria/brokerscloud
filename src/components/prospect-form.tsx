...
return Object.keys(newErrors).length === 0
  ...
  const propertyTypes = ["APARTAMENTO", "CASA", "TERRENO", "COMERCIAL", "OFICINA", "GARAGE", "ALMACEN", "OTRO"]
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth required error={!!errors.type} size={isMobile ? "small" : "medium"} sx={{ mb: 2 }}>
                ...
                <Select
                  labelId="type-label"
                  name="type"
                  value={formData.type || "COMPRADOR"}
                  onChange={handleChange}
                  label="Tipo"
                >
                  <MenuItem value="COMPRADOR">{getTypeLabel("COMPRADOR")}</MenuItem>
                  <MenuItem value="VENDEDOR">{getTypeLabel("VENDEDOR")}</MenuItem>
                  <MenuItem value="INVERSIONISTA">{getTypeLabel("INVERSIONISTA")}</MenuItem>
                  <MenuItem value="ARRENDATARIO">{getTypeLabel("ARRENDATARIO")}</MenuItem>
                  <MenuItem value="PROPIETARIO">{getTypeLabel("PROPIETARIO")}</MenuItem>
                  <MenuItem value="OTRO">{getTypeLabel("OTRO")}</MenuItem>
                </Select>
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                <Select
                  ...
                  name="status"
                  value={formData.status || "POTENCIAL"}
                  onChange={handleChange}
                  label="Estado"
                >
                  <MenuItem value="ACTIVO">{getStatusLabel("ACTIVO")}</MenuItem>
                  <MenuItem value="INACTIVO">{getStatusLabel("INACTIVO")}</MenuItem>
                  <MenuItem value="POTENCIAL">{getStatusLabel("POTENCIAL")}</MenuItem>
                  <MenuItem value="CALIFICADO">{getStatusLabel("CALIFICADO")}</MenuItem>
                  <MenuItem value="CONVERTIDO">{getStatusLabel("CONVERTIDO")}</MenuItem>
                  <MenuItem value="PERDIDO">{getStatusLabel("PERDIDO")}</MenuItem>
                </Select>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth size={isMobile ? "small" : "medium"} sx={{ mb: 2 }}>
                ...
                >
                  ...
                  <MenuItem value="PRESENCIAL">En persona</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={12}>
